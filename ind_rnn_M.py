...
class IndRNNCell(Layer):
    """
    IMPORTANTTTTTTTTTTTTTTTT   NOOOTEEEE
    WE WILL REMOVE THE ACTIVATION FUNCTION OF INDRNN (RELU) AND ADD PRELU AS AN ADDITIONAL LAYER IN "FINE-TUNED INDRNN.IPYNB"
    ...
    # Arguments
        ...
        recurrent_clip_min: Can be one of None, -1 or float.
            ...
            If -1, will calculate the clip value for `None` activation
...
class IndRNN(RNN):
    ...
    # Arguments
        ...
        recurrent_clip_min: Can be one of None, -1 or float.
            If None, clipping of weights will not take place.
            If float, exact value will be used as clipping range
            If -1, computes the default clipping range for None activations
